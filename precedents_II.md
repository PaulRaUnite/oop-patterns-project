...
3. Типичный поток событий:
    ...
    | Действие пользователя | Отклик системы |
    |-----------------------|----------------|
    | Пользователь выбрал Issue | System получило по id Issue из Project. System выводит подробную информацию о Issue. |
...
3. Типичный поток событий:
    ...
    | Действие пользователя | Отклик системы |
    |-----------------------|----------------|
    | Пользователь нажал кнопку «Milestones list» для определённого проекта | System получает список Milestone у Project. System выводит список |
